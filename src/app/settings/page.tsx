...
import { ShutdownHookTab } from '@/components/settings/ShutdownHookTab';
          ...
          <div className="px-4 py-6 sm:px-0">
            ...
            <Tabs defaultValue="appearance">
              <TabsList className="mb-4 flex-wrap">
                ...
                <TabsTrigger value="shutdown-hook">Shutdown Hook</TabsTrigger>
              ...
              <TabsContent value="shutdown-hook">
                <ShutdownHookTab />
              </TabsContent>
