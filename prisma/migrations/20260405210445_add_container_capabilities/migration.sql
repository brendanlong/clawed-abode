-- AlterTable
ALTER TABLE "RepoSettings" ADD COLUMN "enableGpu" BOOLEAN;
ALTER TABLE "RepoSettings" ADD COLUMN "enablePodman" BOOLEAN;
...
CREATE TABLE "new_GlobalSettings" (
    ...
    "enablePodman" BOOLEAN NOT NULL DEFAULT false,
    "enableGpu" BOOLEAN NOT NULL DEFAULT true,
