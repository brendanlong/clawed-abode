/**
 * Lightweight centralized logger for the agent service.
 * Follows the same patterns as the main app's logger (@/lib/logger)
 * but is self-contained for use inside Podman containers.
 */
